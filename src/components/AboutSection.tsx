      ...
      <div className="container mx-auto px-4 relative">
        <div className="max-w-[90rem] mx-auto">
          <div className="text-left mb-24">
            <span className="text-red-600 uppercase tracking-wider text-lg font-bold">Artistic Journey</span>
            <h2 className="text-8xl md:text-[10rem] font-black tracking-tighter mt-4 leading-none">
          ...
          <div className="grid md:grid-cols-5 gap-12">
            <div className="md:col-span-3 aspect-[4/6] rounded-3xl overflow-hidden">
              <img 
