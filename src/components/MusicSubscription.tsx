      ...
      <div className="relative py-32">
        <div className="container mx-auto px-4">
          <div className="text-center mb-24">
            <div
              className="inline-flex items-center gap-4 bg-red-600/20 text-red-500 px-6 py-3 rounded-full mb-8"
              data-editable
              data-name="subscription-label"
            >
              <Music2 size={24} />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto relative">
            ...
            {plans.map((plan) => (
              <div
                key={plan.name}
                className={`relative group ${plan.featured
                    ...
                    <div>
                      ...
                      <div className="flex items-baseline gap-1">
                        <span
                          ...
                          data-editable
                          data-name={`plan-price-${plan.name}`}
                        >
                          ${plan.price}
                        </span>
                  ...
                  <ul className="space-y-4 mb-8">
                    {plan.features.map((feature) => (
                      <li
                        ...
                        data-editable
                        data-name={`plan-feature-${plan.name}-${feature.replace(/\s+/g, '-')}`}
                      >
