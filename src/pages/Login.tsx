        ...
        <div className="max-w-md mx-auto">
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center">
              <span className="bg-black px-4 text-gray-400">Or continue with email</span>
            </div>
          </div>
          ...
          <form onSubmit={handleEmailLogin} className="space-y-4">
            <div>
              ...
              <input
                type="email"
                className="w-full bg-zinc-800 rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-red-500"
                required
              />
            </div>
            <div>
